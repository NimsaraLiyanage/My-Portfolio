...
// Leadership roles grouped by institution — rendered as animated cards.
export const LEADERSHIP = [
  {
    org: "Royal Central College — Polonnaruwa",
    icon: "🎓",
    roles: [
      {
        title: "Senior Prefect — Royal College Prefect Board",
        period: "2015 – 2018",
      },
      {
        title: "Chess Captain — Royal College Chess Team",
        period: "2016 – 2018",
      },
    ],
  },
  {
    org: "Faculty of Engineering — University of Jaffna",
    icon: "⚙️",
    roles: [
      {
        title: "Chess Captain — Engineering Faculty Team",
        period: "2023 – 2024",
      },
    ],
  },
...
export const PROJECTS = [
  {
    ...
    catShort: "MOBILE APP | AWS SERVERLESS",
